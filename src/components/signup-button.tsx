  ...
  return (
    <a
      ...
      className={cn(
        ...
        "rounded-2xl px-6 text-sm font-medium tracking-tight text-neutral-900 sm:text-base",
    ...
    >
      <span>
        <span className="text-xs font-medium text-neutral-600 sm:text-sm">New to Lemonn?</span>
